...
def run_panda_idc_demo():
    ...
    plant.AddJoint(WeldJoint("weld_arm", plant.world_frame(), plant.GetBodyByName("table_top_link").body_frame(),
                                    RigidTransform(RotationMatrix.MakeZRotation(0), [0.8, 0., 0])))

    Parser(plant).AddModels(url="file:///home/cory/Documents/object_models/box.sdf")
    # plant.AddJoint(WeldJoint("weld_arm", plant.world_frame(), plant.GetBodyByName("box_top_link").body_frame(),
